    ...
    <div class="container-fluid">
        ...
        <div class="row-fluid" style="background-color: white; min-height: 1000px; padding:10px;">
            <div class="span12">
                ...
                if (isset($_POST['save'])) {
                   $sql = "INSERT INTO purchesmaster VALUES(NULL,'$_POST[companyName]','$_POST[productName]','$_POST[unitName]','$_POST[packSize]','$_POST[quntity]','$_POST[price]','$_POST[selectParty]','$_POST[pmethod]','$_POST[dt]','$purchesDate','$_SESSION[user]')";
