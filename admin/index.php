...
<body>
    <div id="loginbox">
        <form id="loginform" class="form-vertical" action="" method="post">
            ...
            <div class="form-actions">
                ...
                <p class="btn-danger pull-right" id="user" style="display:none;padding: 8px 10px">Enter Valid User Name</p>
    ...
    <?php 
        ...
        if(isset($_POST['submitt'])){
           ...
           $sql.="WHERE user_name = '$username' and password= '$password' and role = 'admin'";
        //    echo $sql;
           ...
           if(mysqli_num_rows($result)>0){
            ...
            ?>
            <script>
                let err = document.getElementById('user');
